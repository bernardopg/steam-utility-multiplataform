...
- [ ] Add automated CLI parity tests for the remaining upstream commands (`update_stats`, `reset_all_stats`) covering usage text, exit behavior, and legacy JSON payloads on success/failure
